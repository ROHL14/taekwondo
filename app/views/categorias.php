...
<body id="body-pd">
	...
	<div class="container pt-2">
		<section id="centro">
			...
			<div class="content-panel m-5 d-none" id="panelFormulario">
				<div class="row">
					<div class="col-md-10 mx-auto">
						...
						<form class="form-horizontal" role="form" id="miform" enctype="multipart/form-data">
							...
							<div class="form-group row">
								<label for="autor" class="col-sm-2 col-form-label">Categoria</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="categoria" name="categoria" placeholder="Categoria" required autofocus>
								</div>
							</div>
	...
	<script type="text/javascript" src="<?php echo URL; ?>public_html/js/categorias.js"></script>
</body>
