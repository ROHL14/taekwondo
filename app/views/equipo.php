            ...
            <div class="col-md-10 mx-auto">
              ...
              <form class="form-horizontal" role="form" id="miform" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  <label for="equipo" class="col-sm-2 col-form-label">Nombre</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control campo" id="equipo" name="equipo" placeholder="Nombre del equipo" required autofocus>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control campo" id="stock" name="stock" min="1" />
                  </div>
                </div>
